          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <div className="flex flex-col gap-2.5">
              {[
                ...
                { id: 'settlement', to: `/${lang}?tab=settlement#settlement-sourcing`, label: lang === 'ar' ? 'التسويات النقدية والتوريد' : lang === 'zh' ? '双边结算与原厂采购' : lang === 'ckb' ? 'یەکلاییکردنەوەی دارایی و دابینکردن' : 'Bilateral Settlement & Sourcing', targetId: 'settlement-sourcing' },
