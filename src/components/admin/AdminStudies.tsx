  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-top-4 duration-500 text-start">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-neutral-200 pb-8">
        <div>
          <h2 className="text-2xl font-serif font-black text-ink-900 tracking-tight">Sovereign Research Ledger</h2>
        ...
        <button 
          ...
          className="bg-brand-800 hover:bg-brand-700 text-white font-black text-[10px] px-6 py-2.5 rounded-lg uppercase tracking-widest transition-all cursor-pointer shadow-lg flex items-center gap-2"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-8 bg-neutral-50 p-8 rounded-2xl border border-neutral-200 shadow-inner">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1.5">
              <label className="block text-[10px] font-black text-neutral-500 uppercase tracking-widest">Asset Identity (Slug)</label>
            ...
            <div className="space-y-1.5">
              <label className="block text-[10px] font-black text-neutral-500 uppercase tracking-widest">Visibility Protocol</label>
              <div className="flex bg-neutral-200 p-1 rounded-lg">
                <button 
                  type="button"
                  onClick={() => setFormData({...formData, isPrivate: false})}
                  className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 text-[10px] font-black uppercase tracking-wider rounded-md transition-all cursor-pointer ${!formData.isPrivate ? 'bg-white text-ink-900 shadow-sm' : 'text-neutral-500 hover:text-neutral-700'}`}
                >
                  <Unlock size={12} />
                  Public
                </button>
                <button 
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 text-[10px] font-black uppercase tracking-wider rounded-md transition-all cursor-pointer ${formData.isPrivate ? 'bg-brand-800 text-white shadow-sm' : 'text-neutral-500 hover:text-neutral-700'}`}
                >
                  <Lock size={12} />
                  Tier 1 Private
                </button>
          ...
          <div>
             <label className="block text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-1.5">Cover Visualization URL</label>
             <input 
                type="url" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl border border-neutral-200 space-y-4">
                 <h4 className="text-[10px] font-black uppercase tracking-widest text-brand-800 border-b border-neutral-100 pb-2">English Manuscript</h4>
              ...
              <div className="bg-white p-6 rounded-xl border border-neutral-200 space-y-4" dir="rtl">
                 <h4 className="text-[10px] font-black uppercase tracking-widest text-brand-800 border-b border-neutral-100 pb-2 text-start">المخطوطة العربية</h4>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl border border-neutral-200 space-y-4">
                 <h4 className="text-[10px] font-black uppercase tracking-widest text-brand-800 border-b border-neutral-100 pb-2">中文稿件</h4>
              ...
              <div className="bg-white p-6 rounded-xl border border-neutral-200 space-y-4" dir="rtl">
                 <h4 className="text-[10px] font-black uppercase tracking-widest text-brand-800 border-b border-neutral-100 pb-2 text-start">دەستنووسی کوردی</h4>
          ...
          <div className="flex justify-end gap-4">
             <button 
              ...
              className="px-8 py-3 text-[10px] font-black uppercase tracking-widest text-neutral-500 hover:text-ink-900 transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button 
              ...
              className="bg-brand-800 hover:bg-brand-700 text-white font-black text-[10px] px-12 py-3 rounded-xl uppercase tracking-widest transition-all cursor-pointer shadow-xl flex items-center gap-2"
            >
            ...
            <div key={study.id} className="bg-white border border-neutral-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col group">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <h4 className="text-lg font-serif font-black text-ink-900 leading-tight line-clamp-2">{study.titleEn}</h4>
                ...
                <div className="pt-6 mt-6 border-t border-neutral-100 flex justify-between items-center">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] font-bold text-neutral-300 uppercase tracking-widest">4 Languages</span>
                  </div>
                  <div className="flex gap-2">
                    <button className="p-2 text-neutral-300 hover:text-ink-900 transition-colors cursor-pointer">
                      <FileText size={16} />
                    </button>
                    <button 
