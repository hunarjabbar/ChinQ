  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-xs flex items-center justify-center p-4 sm:p-6 font-sans">
      ...
      >
        ...
        <div className="p-8 sm:p-10 space-y-6 text-start text-ink-900 dark:text-neutral-100 bg-white dark:bg-neutral-900">
          ...
          <div className="border-b-2 border-brand-800 pb-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-start">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-serif font-black tracking-tight text-brand-800 dark:text-brand-400">
            ...
            <div className="text-end font-mono text-xs">
              ...
              <div className="text-[10px] text-neutral-400">{new Date(order.createdAt).toLocaleDateString()}</div>
            </div>
          </div>
          ...
          <div className="text-center py-2 bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 rounded-xl">
            <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-neutral-500 dark:text-neutral-400 block">
              Cryptographic Transaction Dossier
            </span>
            <span className="text-sm font-black uppercase text-ink-900 dark:text-white">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
            <div className="p-3 bg-neutral-50 dark:bg-neutral-800/40 rounded-lg border border-neutral-200 dark:border-neutral-700">
              <span className="text-[9px] uppercase text-neutral-400 block">Gross Sent</span>
            ...
            <div className="p-3 bg-neutral-50 dark:bg-neutral-800/40 rounded-lg border border-neutral-200 dark:border-neutral-700">
              <span className="text-[9px] uppercase text-neutral-400 block">Applied Rate</span>
            ...
            <div className="p-3 bg-neutral-50 dark:bg-neutral-800/40 rounded-lg border border-neutral-200 dark:border-neutral-700">
              <span className="text-[9px] uppercase text-neutral-400 block">Clearing Fee</span>
            ...
            <div className="p-3 bg-brand-50/50 dark:bg-brand-950/30 rounded-lg border border-brand-300 dark:border-brand-700">
              <span className="text-[9px] uppercase text-brand-800 dark:text-brand-300 block">Net Credited</span>
          ...
          <div className="border border-neutral-200 dark:border-neutral-700 rounded-xl divide-y divide-neutral-200 dark:divide-neutral-700 text-xs">
            ...
            <div className="p-3 flex justify-between items-center">
              ...
              <span className="font-mono text-brand-800 dark:text-brand-400 font-bold">
          ...
          <div className="pt-4 border-t border-neutral-200 dark:border-neutral-700 grid grid-cols-2 gap-6 text-center text-[10px] font-mono text-neutral-500">
            <div className="p-3 border border-dashed border-neutral-300 dark:border-neutral-700 rounded-lg">
              <div className="font-bold uppercase text-ink-900 dark:text-white mb-1">
                People's Bank of China (PBOC)
              </div>
              <div>Digital Currency Research Node</div>
              <div className="text-[9px] text-emerald-600 dark:text-emerald-400 mt-1">
