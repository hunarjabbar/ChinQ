  ...
  return (
    <div className="min-h-screen bg-paper-50 flex flex-col items-center justify-center p-4 font-sans text-ink-900 w-full">
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="pt-4">
          <Link to={`/${lang}`} className="inline-flex items-center gap-2 bg-brand-800 text-white px-8 py-3 rounded-xs font-mono font-bold uppercase tracking-widest hover:bg-brand-800 transition-colors">
