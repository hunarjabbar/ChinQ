    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 font-medium text-xs mt-1">Manage global partners, logos, and localized descriptions.</p>
        </div>
        <button 
          onClick={() => openModal()}
            ...
            >
              ...
              <form onSubmit={handleSave} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1">Partner Name</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1">Website URL</label>
                ...
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1 flex items-center gap-1"><ImageIcon size={12}/> Logo URL or SVG Upload</label>
                  ...
                  {formData.logoUrl && (
                    <div className="mt-2 p-3 border border-dashed border-gray-300 inline-flex items-center gap-4 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-xs font-medium text-gray-500 truncate max-w-[200px]">{formData.logoUrl}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1">Order (Sorting)</label>
                ...
                <div className="border-t border-gray-100 pt-4 mt-4">
                  <h3 className="text-xs font-black uppercase text-brand-800 mb-4">Localized Descriptions</h3>
