...
const figures = [
  ...
  { name: 'Sheikh Mahmud Barzanji (Malik Mahmud)', region: 'Kurdish', title: 'King of Kurdistan and Anti-Colonial Leader', keywords: ['Sulaymaniyah', 'British Mandate', 'Kingdom of Kurdistan', 'Rebellion', 'Anti-colonialism', 'Exile', 'India', 'Qadiriyya', 'Legacy', 'Sovereignty'] }
];
