...
export async function seedTourism() {
  try {
    ...
    console.log(`[TourismSeeder] Found ${count} tourism spots in database. Checking for updates...`);
    ...
    const spots = [
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1627671398188-752109e2365a?auto=format&fit=crop&q=80&w=1200",
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1599933333390-21ba29302636?auto=format&fit=crop&q=80&w=1200",
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1632766861250-936ba77b0743?auto=format&fit=crop&q=80&w=1200",
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1541888052140-59dc93539169?auto=format&fit=crop&q=80&w=1200",
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1564349683136-77e08dba1ef9?auto=format&fit=crop&q=80&w=1200",
