    ...
    const features = [
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1580894732444-8ecded7900cd?auto=format&fit=crop&q=80&w=1200",
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1573497019236-17f8177b81e8?auto=format&fit=crop&q=80&w=1200",
      ...
      },
      {
        ...
        nameEn: "Women's Role in Eurasian Silk Road Heritage & Modern Diplomacy",
        nameAr: "دور المرأة في التراث والدبلوماسية لطريق الحرير الأوراسي",
        nameZh: "女性在欧亚丝绸之路遗产与现代外交中的角色",
        nameCkb: "ڕۆڵی ئافرەتان لە کەلەپوور و دیپلۆماسی ڕێگای ئاوریشم",
